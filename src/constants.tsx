...
export const MENU_ITEMS = [
  { id: 'dashboard', label: 'Dashboard', icon: <LayoutDashboard className="w-5 h-5" />, roles: ['Admin', 'Checklist', 'Maintenance', 'Security'] },
  { id: 'cleaning', label: 'Checklist Kebersihan', icon: <Brush className="w-5 h-5" />, roles: ['Admin', 'Checklist'] },
  { id: 'maintenance', label: 'Realisasi Pemeliharaan', icon: <Wrench className="w-5 h-5" />, roles: ['Admin', 'Maintenance'] },
